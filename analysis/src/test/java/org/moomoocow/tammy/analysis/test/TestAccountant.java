...
public class TestAccountant {
  ...
  public void testBuyAll() {
    dm.transact(1.0, new Date(), new Action(ActionType.BUY,null,null));
  ...
  public void testSellAll() {
    dm.transact(1.0, new Date(), new Action(ActionType.BUY,null,null));
    dm.transact(1.0, new Date(), new Action(ActionType.SELL,null,null));
...
*/
  ...
  public void testGetPeriodAfterLastDealExclWeekends() {    
    dm.transact(1.0, new GregorianCalendar(2013,0,3).getTime(), new Action(ActionType.BUY,null,null));    
